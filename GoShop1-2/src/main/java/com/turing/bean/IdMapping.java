...
public class IdMapping {
	...
	public String toString() {
		return "IdMapping [id=" + id + ", orderId=" + orderId + ", stockId=" + stockId + ", enquireId=" + enquireId
				+ ", contAppId=" + contAppId + ", quoteId=" + quoteId + ", contId=" + contId + ", status=" + status
				+ "]";
	}

	public IdMapping(Long orderId, Long stockId, String status) {
		super();
		this.orderId = orderId;
		this.stockId = stockId;
		this.status = status;
